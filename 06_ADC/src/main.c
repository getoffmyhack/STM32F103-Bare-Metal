...
volatile uint16_t       scroll_delay_ms     = 100;
...
//    }
    ...
    scroll_delay_count++;
    if(scroll_delay_count >= scroll_delay_ms)
    {
    ...
    // map the ADC value to be between 0 and 1000 (no delay to 1 second)
    scroll_delay_ms = map_16bit(adc_value, 0, 4096, 0, 1000);
}
...
void init_matrix(void)
{
    ...
    send_to_max(MAX7219_REG_INTENSITY, MAX7219_DUTY_CYCLE_3_32);
